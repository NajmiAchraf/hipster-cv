...
\begin{tabular}{r| p{0.4\textwidth} c}
    \cvresume{2019--2021}{IT Development}{\faPython \hspace{0.1em} Python 3 : Syntax, GUI, Data Science}{./pic/python.png} \\
    
    \cvresume{2017--2021}{Computer Maintenance FreeLance}{Diagnostic and reparation of Hardware \& Software...}{./pic/computer-maintenance.png} \\
    
    \cvuniv{2012--2019}{University Studies}{Physics Electronic}{./pic/univh2fsbm.png}
\end{tabular}
