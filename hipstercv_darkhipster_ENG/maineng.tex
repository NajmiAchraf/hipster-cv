...
\begin{tabular}{r| p{0.5\textwidth} c}
	...
	\cvdegree{2020}{Project Hydrogéologie}{\icon{\faPython}{headerblue}{} Python 3.7}{Groundwater Hydrology\color{cvorange}}{\href{https://github.com/DeepEastWind/Hydrogeologie}{\icon{\faGithub}{cvpurple}{}github.com/DeepEastWind/Hydrogeologie (PRIVATE PROJECT)}}{./pic/earth.png} \\

    \cvdegree{2020}{Project MathPy}{\icon{\faPython}{headerblue}{} Python 3.7}{Modern Scientific Calculator\color{cvorange}}{\href{https://www.github.com/DeepEastWind/MathPy}{\icon{\faGithub}{cvpurple}{}github.com/DeepEastWind/MathPy (PRIVATE PROJECT)}}{./pic/MathPy.png} \\
    
    \cvdegree{2018}{Project Graduation}{UHIIC}{Faculty of Science Ben M'sick \color{cvorange}}{Design of a photovoltaic system and realization of a solar tracker}{./pic/univh2fsbm.png} \\
