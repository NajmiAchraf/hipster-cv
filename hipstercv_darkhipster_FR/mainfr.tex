...
\begin{piechart}{360}{1}{darkgray}{iconcolour}{skilllabelcolour}
			\slice{33}{Développement}{headerblue}
			\slice{28}{Maintenance}{cvyellow}
			\slice{23}{Schématisation}{orange}
			\slice{18}{Désigne}{cvpurple}
...
\begin{timelinehorizontal}{2017}{2022}{11}{black!70}
			...
			\cvevent{2/2017}{9/2018}{Maintenance Informatique}{1}{-4.5}{headerblue}{white}{-1.1}
	
			\cvevent{9/2017}{6/2019}{Études de licence : Physique Électronique}{1.6}{-7}{cvyellow}{headerfontbox}{-1}
			
			\cvevent{9/2019}{3/2021}{Développement Informatique : \hspace{0.1em} \faPython \hspace{0.1em} Python 3 : Syntaxe, GUI, Data Science}{2.2}{-5.5}{headerblue}{white}{-0.9}
...
\mbox{
	\parbox[b][2cm][c]{7.5cm}{
		...
		% \hspace{1em}
		\hobbyicon{\color{labelcolour}\faNewspaper}{Actualités \\Technologies}{cvpurple}{\iconsize}{2em} % \hfill
		% \hspace{1em}
