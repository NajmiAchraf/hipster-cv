...
\section*{Projets}
\begin{tabular}{r| p{0.45\textwidth} c}
    \cvpython{2021}{Projet de Hydrogéologie}{Python 3.7}{Hydrologie des eaux souterraines \color{cvyellow}}{\href{https://github.com/DeepEastWind/Hydrogeologie}{\icon{\faGithub}{cvpurple}{}\textcolor{black!70}{github.com/DeepEastWind/Hydrogeologie (PROJET PRIVÉ)}}}{./pic/earth.png} \\
    
    \cvpython{2020}{Projet de MathPy}{Python 3.7}{Calculatrice Scientifique Moderne \color{cvyellow}}{\href{https://www.github.com/DeepEastWind/MathPy}{\icon{\faGithub}{cvpurple}{}\textcolor{black!70}{github.com/DeepEastWind/MathPy (PROJET PRIVÉ)}}}{./pic/MathPy.png} \\
