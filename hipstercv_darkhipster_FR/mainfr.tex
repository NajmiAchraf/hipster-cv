...
\section*{Projets}
\begin{tabular}{r| p{0.5\textwidth} c}
    \cvdegree{2020}{Projet de Hydrogéologie}{\icon{\faPython}{headerblue}{} Python 3.7}{Hydrologie des eaux souterraines\color{cvorange}}{\href{https://github.com/DeepEastWind/Hydrogeologie}{\icon{\faGithub}{cvpurple}{}github.com/DeepEastWind/Hydrogeologie (PROJET PRIVÉ)}}{./pic/earth.png} \\
    
    \cvdegree{2020}{Projet de MathPy}{\icon{\faPython}{headerblue}{} Python 3.7}{Calculatrice Scientifique Moderne\color{cvorange}}{\href{https://www.github.com/DeepEastWind/MathPy}{\icon{\faGithub}{cvpurple}{}github.com/DeepEastWind/MathPy (PROJET PRIVÉ)}}{./pic/MathPy.png} \\
    
    \cvdegree{2018}{Projet de Fin d'Études}{UHIIC}{Faculté des Sciences Ben M'sick \color{cvorange}}{Conception d'un système photovoltaïque et réalisation d'un suiveur solaire}{./pic/univh2fsbm.png} \\
