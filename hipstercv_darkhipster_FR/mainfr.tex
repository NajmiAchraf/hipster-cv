...
\footnotesize
{\setasidefontcolour
\bgupper{yellow}{iconcolour}{Faits} \\
\bg{yellow}{iconcolour}{Personnel} \\
...
\bgupper{yellow}{iconcolour}{Étude} \\
\bg{yellow}{iconcolour}{Spécialisée} \\

Électronique ~•~ Electrotechnique  \\Numérique ~•~ Télécommunication ~•~ Réseau

\bigskip

\bgupper{yellow}{iconcolour}{Capacités} \\
\bg{yellow}{iconcolour}{Langues}
\bigskip
...
\bg{yellow}{iconcolour}{Informatique et Programmation}\\
...
\bg{yellow}{iconcolour}{Programmes Logiciels} \\
...
\begin{piechart}{360}{1}{darkgray}{iconcolour}{skilllabelcolour}
			\slice{12}{Projets}{green}
			\slice{29}{Développement}{headerblue}
			\slice{29}{Maintenance}{yellow}
			\slice{16}{Recherche}{orange}
			\slice{14}{Désigne}{cvpurple}
