...
\begin{timelinehorizontal}{2017}{2022}{11}{timelinecolour}
			...
			\cvevent{9/2017}{6/2019}{Études de licence : Physique Électronique}{1.6}{-7}{cvyellow}{iconcolour}{-0.9}
			
			\cvevent{9/2019}{3/2021}{Développement Informatique : \hspace{0.1em} \faPython \hspace{0.1em} Python 3 : Syntaxe, GUI, Data Science}{2.2}{-5.5}{cvyellow}{iconcolour}{-0.9}
...
\section*{Projets}
\begin{tabular}{r| p{0.45\textwidth} c}
    \cvpython{2021}{Projet de Hydrogéologie}{Python 3.7}{Hydrologie des eaux souterraines \color{cvyellow}}{\href{https://github.com/DeepEastWind/Hydrogeologie}{\icon{\faGithub}{cvpurple}{}\textcolor{black!70}{github.com/DeepEastWind/Hydrogeologie (PRIVATE PROJECT)}}}{./pic/earth.png} \\
    
    \cvpython{2020}{Projet de MathPy}{Python 3.7}{Calculatrice Scientifique Moderne \color{cvyellow}}{\href{https://www.github.com/DeepEastWind/MathPy}{\icon{\faGithub}{cvpurple}{}\textcolor{black!70}{github.com/DeepEastWind/MathPy (PRIVATE PROJECT)}}}{./pic/MathPy.png} \\
...
\mbox{
	\parbox[b][2cm][c]{7.5cm}{
		\hobbyicon{\color{iconcolour}\faPlayCircle}{Tutoriels \\}{cvyellow}{\iconsize}{2em}
		% \hspace{1em}
		\hobbyicon{\color{iconcolour}\faNewspaper}{Actualités \\Technologies}{cvred}{\iconsize}{2em} % \hfill
		% \hspace{1em}
		\hobbyicon{\color{iconcolour}\faChess}{Jeux \\Cérébrale}{cvgreen}{\iconsize}{2em}
		\hspace{1em}
