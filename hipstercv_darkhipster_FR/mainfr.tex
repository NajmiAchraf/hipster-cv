...
\begin{tabular}{r| p{0.4\textwidth} c}
    \cvresume{2019--2021}{Développement Informatique}{\faPython \hspace{0.1em} Python 3 : Syntaxe, GUI, Data Science}{./pic/python.png} \\
    
    \cvresume{2013--2021}{Maintenance Informatique FreeLance}{Diagnostique et réparation de Hardware \& Software...}{./pic/computer-maintenance.png} \\
    
    \cvuniv{2012--2019}{Études Universitaires}{Physique Électronique}{./pic/univh2fsbm.png}
\end{tabular}
